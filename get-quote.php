...
<head>
    ...
    <script src="js/loading/modernizr-2.6.2.min.js"></script>
...
<div class="container p_0" style="text-align: center">
<h1>Thank you <?php print stripslashes($_REQUEST['name']); ?></h1>
          <h2><br />
          Your message has been sent. We will be get back to you soon.</h2>
          <br />
          <br />
          <p><a class="contact" href="index.html">Click here if your browser does not automatically redirect you</a></p>
</div>         
</section>          
</body>
</html>